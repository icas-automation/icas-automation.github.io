...
<Steps>
  1. Po zakupie pełnej wersji oprogramowania EMS Prime Switch system samodzielnie zweryfikuje licencję i odblokuje pełną wersję systemu na Twojej centrali.
  2. Cały ten proces odbywa się w pełni automatycznie, bez konieczności wykonywania dodatkowych czynności z Twojej strony.
</Steps>